...
namespace WebApplication1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RecyclingNowContext>(options => options.UseSqlServer(connection));
            ...
            services.AddTransient<Microsoft.AspNetCore.Identity.IUserValidator<User>, CustomUserValidator>();
